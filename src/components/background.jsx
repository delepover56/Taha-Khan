  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden bg-[#050a08]">
      ...
      <div className="absolute inset-0 opacity-25 [mask-image:radial-gradient(circle_at_center,_black_0%,_transparent_70%)]">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_24%_28%,_rgba(0,255,94,0.16),_transparent_24%),_radial-gradient(circle_at_76%_64%,_rgba(0,155,57,0.12),_transparent_28%),_linear-gradient(135deg,_transparent,_rgba(0,255,94,0.08),_transparent)] animate-[ambientDrift_40s_linear_infinite]" />
      </div>
