    ...
    <header className="sticky top-4 z-[120] w-full lg:hidden">
      <div className="flex items-center justify-between rounded-2xl border border-[#00ff5e26] bg-[#0a120db8] px-5 py-4 backdrop-blur-xl shadow-[0_10px_24px_rgba(0,0,0,0.45)]">
        ...
        <button
          ...
          className="flex h-11 w-11 items-center justify-center rounded-xl border border-[#00ff5e44] bg-[#06180f] transition-all duration-300 hover:border-[#00ff5e] hover:bg-[#00ff5e1a]"
        >
          <span
            className={[
      ...
      >
        <div className="mb-8 flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={() => setIsOpen(false)}
            className="rounded-full border border-[#00ff5e44] bg-[#06180f] px-3 py-1 text-xs uppercase tracking-[0.25em] text-[#9fffbf]"
          >
            Close
          </button>
        </div>
