    ...
    >
      ...
      >
        ...
        <p className="poppins type-body mt-5 leading-relaxed text-[#c7ffd8] xs:mt-6">
          I build responsive frontend experiences with{" "}
          <span className="text-[#00ff5e]">HTML</span>,{" "}
          <span className="text-[#00ff5e]">CSS</span>, and{" "}
          <span className="text-[#00ff5e]">JavaScript</span>, while growing a
          stronger <span className="text-[#00ff5e]">React.js</span> workflow.
          My background also includes practical WordPress, Shopify, and CMS
          delivery, with <span className="text-[#00ff5e]">Next.js</span> on the
          roadmap for more advanced production patterns.
        </p>
      </motion.div>
